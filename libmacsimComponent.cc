...
static const ElementInfoPort macsim_ports[] = {
    ...
    {"core%(core_id)d-ccache",
     "Ports connected to const cache (only for GPU core)", NULL},
    {"core%(core_id)d-tcache",
     "Ports connected to texture cache (only for GPU core)", NULL},
    {NULL, NULL, NULL}};

static const ElementInfoComponent components[] = {
    {"macsimComponent", "MacSim Simulator", NULL, create_macsimComponent,
     macsim_params, macsim_ports, COMPONENT_CATEGORY_PROCESSOR},
