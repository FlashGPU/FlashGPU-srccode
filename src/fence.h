...
class fence_list {
 ...
 public:
   ...
   */
  bool is_list_empty(void) { return m_fence_list.empty(); }

  list<int>::const_iterator cbegin() const { return m_fence_list.cbegin(); }

  list<int>::const_iterator cend() const { return m_fence_list.cend(); }
};
...
class fence_c {
 ...
 public:
  fence_c(macsim_c *simBase) { m_simBase = simBase; }
