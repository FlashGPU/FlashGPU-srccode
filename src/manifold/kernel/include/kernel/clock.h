...
class Clock {
 public:
  ...
  /** Processes all rising edge callbacks that have been registered with the
   * clock.
   */
  void Rising();

  /** Processes all falling edge callbacks that have been registered with the
   * clock.
   */
  void Falling();
 ...
 public:
   ...
   */
  template <typename O>
  static tickObjBase *Register(Clock &whichClock, O *obj,
                               void (O::*rising)(void),
                               void (O::*falling)(void));
...
template <typename O>
tickObjBase *Clock::Register(O *obj, void (O::*rising)(void),
                             void (O::*falling)(void)) {
...
template <typename O>
tickObjBase *Clock::Register(Clock &c, O *obj, void (O::*rising)(void),
                             void (O::*falling)(void)) {
