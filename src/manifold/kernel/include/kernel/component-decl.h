...
class ComponentLpMapping {
 public:
   ...
   *  @arg \c l LpId
   */
  ComponentLpMapping(Component *c, LpId_t l) : component(c), lp(l) {}
...
class Component {
 public:
   ...
   */
  template <typename T>
  Link<T> *AddOutputLink(int outIndex) throw(LinkTypeMismatchException);
  ...
  void AddInput(int inputIndex, void (T::*handler)(int, T2), T *obj, Clock *c,
  ...
  void Recv_remote(int inputIndex, Ticks_t sendTick, Ticks_t recvTick,
                   Time_t sendTime, Time_t recvTime, unsigned char *data,
                   int len);
  ...
  static CompId_t Create(LpId_t, const T1 &, const T2 &,
                         CompName_t name = "None");
  ...
  static CompId_t Create(LpId_t, const T1 &, const T2 &, const T3 &,
                         CompName_t name = "None");
  ...
  static CompId_t Create(LpId_t, const T1 &, const T2 &, const T3 &, const T4 &,
                         CompName_t name = "None");
