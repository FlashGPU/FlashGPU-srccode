...
class tickObjTest : public CppUnit::TestFixture {
 public:
  ...
  void testCallRisingTick_0() {
    ...
    tickObj<MyObj1> *tobj =
        new tickObj<MyObj1>(comp, &MyObj1::risingTick, &MyObj1::fallingTick);
  ...
  static CppUnit::Test *suite() {
    ...
    mySuite->addTest(new CppUnit::TestCaller<tickObjTest>(
        "testCallRisingTick_0", &tickObjTest::testCallRisingTick_0));
    mySuite->addTest(new CppUnit::TestCaller<tickObjTest>(
        "testCallRisingTick_1", &tickObjTest::testCallRisingTick_1));
    mySuite->addTest(new CppUnit::TestCaller<tickObjTest>(
        "testCallFallingTick_0", &tickObjTest::testCallFallingTick_0));
    mySuite->addTest(new CppUnit::TestCaller<tickObjTest>(
        "testCallFallingTick_1", &tickObjTest::testCallFallingTick_1));
