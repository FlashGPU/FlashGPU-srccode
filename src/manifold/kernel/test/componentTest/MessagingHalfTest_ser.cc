...
//! master clock. The delay is specified in half ticks. This program tests
//! non-primitive types that are sent between the two components. The data type
//! must implement Serialize() and Deserialize(). In this program data is passed
//! by value.
//!
#include <Test.h>
...
class MessagingTest : public CppUnit::TestFixture {
 ...
 public:
  ...
  void test_messaging() {
    ...
    // connect the two
    Manifold ::ConnectHalf(c0, MyObj1::C0_OUT, c1, MyObj1::C1_IN,
