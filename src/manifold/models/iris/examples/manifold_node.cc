...
int main(int argc, char *argv[]) {
  ...
  cerr << "\n------------------------------------------------------------------"
          "-----------------\n";
  cerr
      << "** IRIS - Cycle Accurate Network Simulator for On-Chip Networks **\n";
  ...
  manifold::kernel::CompId_t terminal_id =
      manifold::kernel::Component::Create<PktGen>(0);
  manifold::kernel::CompId_t ninterface0_id =
      manifold::kernel::Component::Create<NInterface>(0);
  manifold::kernel::CompId_t router0_id =
      manifold::kernel::Component::Create<SimpleRouter>(0);
  manifold::kernel::CompId_t mc_id =
      manifold::kernel::Component::Create<SimpleMC>(0);
  ...
  terminal =
      manifold::kernel::Component::GetComponent<ManifoldTerminal>(terminal_id);
  ninterface0 =
      manifold::kernel::Component::GetComponent<IrisInterface>(ninterface0_id);
  ...
  ninterface1 =
      manifold::kernel::Component::GetComponent<IrisInterface>(ninterface1_id);
  mc = manifold::kernel::Component::GetComponent<ManifoldTerminal>(mc_id);

  std::cout << " ninterface0 id : " << ninterface0->GetComponentId()
            << std::endl;
  std::cout << " ninterface1 id : " << ninterface1->GetComponentId()
            << std::endl;
  ...
  manifold::kernel::Clock::Register<ManifoldTerminal>(
      terminal, &ManifoldTerminal::tick, &ManifoldTerminal::tock);
  ...
  manifold::kernel::Clock::Register<IrisRouter>(router1, &IrisRouter::tick,
                                                &IrisRouter::tock);
  manifold::kernel::Clock::Register<ManifoldTerminal>(
      mc, &ManifoldTerminal::tick, &ManifoldTerminal::tock);
